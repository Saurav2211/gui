...
# Text label
text1 = Label(master=frame1,
              text="This is a fake currency detection sytem. Select the currency type, browse your image file and get started!",
              fg='blue', font="Verdana 10")
text1.pack()
